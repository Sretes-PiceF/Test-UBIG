...
import { X, Calendar, Upload, Image, FileText, AlertCircle } from 'lucide-react';
...
export function LogbookUpdateModal({ 
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(`${baseUrl}/siswa/logbook/update/${logbook?.id}`, {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                if (response.status === 422) {
                    ...
                    throw new Error(result.message || 'Validasi gagal, periksa kembali data yang diisi');
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {fieldErrors.tanggal && (
                                <p className="text-red-500 text-xs animate-fadeIn">{fieldErrors.tanggal}</p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {fieldErrors.kegiatan && (
                                <p className="text-red-500 text-xs animate-fadeIn">{fieldErrors.kegiatan}</p>
                            )}
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {fieldErrors.kendala && (
                                <p className="text-red-500 text-xs animate-fadeIn">{fieldErrors.kendala}</p>
                            )}
                            <p className="text-xs text-gray-500">
                        ...
                        <div className="space-y-2">
                            ...
                            {fieldErrors.file && (
                                <p className="text-red-500 text-xs animate-fadeIn">{fieldErrors.file}</p>
                            )}
